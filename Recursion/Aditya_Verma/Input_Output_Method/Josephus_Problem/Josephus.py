...
def find_josephus(persons, k, sword_index=0) -> int:
    ...
    print("Person died = ", persons[delete_index])  # Not necessary
...
if __name__ == "__main__":
    # print(find_last_living_person(2, 1))
    # print(find_last_living_person(5, 2))
    # print(find_last_living_person(4, 2))
    print(find_last_living_person(40, 7))
    # print(find_last_living_person(50, 10))
