...
def find_symbol_in_grammar__even_odd_approach(n: int, k: int) -> str:
    # Base Case
    if n == 1 and k == 1:
        return '0'

    # Hypothesis
    parent_symbol = find_symbol_in_grammar__even_odd_approach(n - 1, (k + 1) // 2)
...
if __name__ == "__main__":
    ...
    # n, k = 2, 2
    n, k = 4, 5
    print(find_symbol_in_grammar__even_odd_approach(n, k))
