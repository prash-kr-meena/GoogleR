from Stack.Aditya_Verma.Index__Greater_n_Smaller_Nums_To_Left_n_Right.NSL_Index import \
    indexes_of_next_smaller_element_to_left
from Stack.Aditya_Verma.Index__Greater_n_Smaller_Nums_To_Left_n_Right.NSR_Index import \
