...
class WeightedUniDirectedGraph:
    CONNECTED = 1
    NOT_CONNECTED = 0
    VISITED = True
    UN_VISITED = False
    ...
    def print_depth_first(self):
        ...
        visited = [WeightedUniDirectedGraph.UN_VISITED] * n  # Array : to check if already visited in O(1)
    ...
    def _print_dfs(self, start_vertex, visited: list):
        ...
        visited[start_vertex] = WeightedUniDirectedGraph.VISITED  # marking visited
